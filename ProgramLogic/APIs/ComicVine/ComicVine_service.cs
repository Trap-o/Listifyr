...
namespace Listifyr.ProgramLogic.APIs.ComicVine
{
    ...
    {
        private const string apiKey = "c585e860edd854ff8920c60d881d51750c924b04";
        private const string apiUrl = "https://comicvine.gamespot.com/api/search/?api_key=" + apiKey + "&format=json&resources=issue&query=";
